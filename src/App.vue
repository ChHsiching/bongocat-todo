...
import { setupMailPlugin, useMailAccountStore, useMailSettingsStore } from './plugins/mail'
...
onMounted(async () => {
  ...
  await setupMailPlugin({ mailAccountStore, mailSettingsStore, windowLabel: appWindow.label })
})
